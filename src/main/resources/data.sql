...
insert  into `product_line`(`product_line`,`text_description`,`html_description`,`image`) values
...
insert  into `product`(`product_code`,`product_name`,`product_line`,`product_scale`,`product_vendor`,`product_description`,`quantity_in_stock`,`buy_price`,`msrp`) values
